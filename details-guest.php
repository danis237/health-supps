             ...
             <div class="col-sm-6">
               <div class="box">
                 ...
                 <form action="details.php?add_cart=<?php echo $pro_id ?>" method="post" class="form-horizontal">
                   ...
                   <a class="btn btn-custom-cart" href="register.php">
                     <script>window.alert("Note:Must Be a member to START SHOPPING!")</script>
                      <i class="fa fa-shopping-cart"></i>Register and Start Shopping
                   </a>
